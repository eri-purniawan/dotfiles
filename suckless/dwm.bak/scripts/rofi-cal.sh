...
THEME="/home/eri/.cache/wal/rofi-cal.rasi"
...
PROMPT2="<span foreground=\"#e06b74\"><b>  Sun  Mon  Tue   Wed  Thu  Fri  Sat</b></span>"
...
"$NEXT_MONTH")
    ...
    /home/eri/suckless/dwm/scripts/rofi-cal.sh "$YEAR-$MONTH"
    ;;
"$PREV_MONTH")
    ((MONTH = MONTH - 1))
    if [ "$MONTH" -lt 1 ]; then
