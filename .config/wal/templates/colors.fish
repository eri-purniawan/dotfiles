...
set fish_color_autosuggestion {color9}
set fish_color_user {color2}
# set fish_color_host normal
set fish_color_host $fish_color_normal
set fish_color_valid_path --underline
set fish_color_cwd {color2}
set fish_color_cwd_root {color2}
set fish_color_match --background={color4}
set fish_color_search_match {color3} --background={color0}
set fish_color_selection {color7} --bold --background={color0}
set fish_color_cancel -r
set fish_pager_color_prefix {color7} --bold --underline
set fish_pager_color_completion
# set fish_pager_color_description B3A06D yellow
set fish_pager_color_description $fish_color_quote {color4}
set fish_pager_color_progress brwhite --background={color6}
